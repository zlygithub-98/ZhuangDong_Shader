...
////// Emissive:
                ...
                float4 _Cubemap_var = texCUBElod(_Cubemap,float4(reflect((viewDirection*(-1.0)),node_2073.rgb),_CubemapMip_var));
                float3 emissive = _Cubemap_var.rgb;
