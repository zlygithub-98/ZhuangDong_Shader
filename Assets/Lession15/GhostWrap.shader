Shader "Unlit/GhostWrap"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float4 _WarpTex_ST; //使用到了他的方法 声明这个变量
            ...
            {
                half3 var_WarpTex = tex2D(_WarpTex, o.uv1).rgb;
                half2 uvBias = (var_WarpTex.rg - 0.5) * _WarpInt;
                half2 customUV = uvBias + o.uv0;
                half4 var_MainTex = tex2D(_MainTex, customUV);
