    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _node_5171)
...
////// Emissive:
                ...
                float node_3698 = 1.0;
                float2 node_8521 = float2(node_8075,node_3698);
                ...
                float _node_5171_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_5171 );
                float node_6356_if_leA = step(node_8075,_node_5171_var);
                float node_6356_if_leB = step(_node_5171_var,node_8075);
