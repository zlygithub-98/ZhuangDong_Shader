...
////// Emissive:
                ...
                float3 emissive = ((attenuation*((_lightColor_var.rgb*_lightPower_var)*((_baseColor_var.rgb*saturate(dot(i.normalDir,lightDirection)))+pow(saturate(dot(lightDirection,viewReflectDirection)),_power_var))))+(((_baseColor_var.rgb*(((_upColor_var.rgb*node_7275)+(node_2704*_downColor_var.rgb))+(_MiddleColor_var.rgb*((node_9109-node_7275)-node_2704))))*_EnvColorLevel_var)*_occoluision_var.rgb));
